...
<body>
    ...
    <div class="button-container">
        <form method="post" action="placeOrder.php" class="button-form">
            ...
            <button type="submit" name="buy_book">Add to Cart</button>
        </form>
        <a href="bookspdf/<?php echo $row['pdfs']; ?>"><button>Read now</button></a>
    </div>
</td>
<?php
